...
class Role
  ...
  def administrated_objects
    directly_administrated_objects + directly_administrated_objects.collect do |obj|
      if obj.kind_of? Group
        obj.descendants
      elsif obj.kind_of? Page
        obj.connected_descendant_pages
      end
    end.flatten
  end
