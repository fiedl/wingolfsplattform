class Page < ApplicationRecord
  ...
  scope :without_group, -> {
    where("pages.id NOT IN (#{Dag::Traversal.descendant_ids_sql(ancestor_type: 'Group',
      descendant_type: 'Page', ancestor_ids: :all)})")
  }
  ...
  # All posts of this page's subtree. Formerly an alias generated by
  # has_dag_links; the blog listing on public pages reads this.
  #
  def posts
    descendant_posts
  end
