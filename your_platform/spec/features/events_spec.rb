...
feature "Events" do
  ...
  describe "invitation email" do
    ...
    scenario "sending an invitation email", js: true do
      ...
      email_text.should include I18n.localize(@event.start_at.in_time_zone(@user.time_zone))
      email_text.should include I18n.localize(@event.end_at.in_time_zone(@user.time_zone)) if @event.end_at
    end
  end
