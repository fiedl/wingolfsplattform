...
describe UserCorporations do
  ...
  # Implicit corporation creation by name is disabled for now, see the
  # UserCorporations concern. We might re-use this later for a scenario
  # where the corporation represents the company of a contact.
  #
