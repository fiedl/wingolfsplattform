...
describe StructureableRoles do

  before do
    class MyStructureable < ApplicationRecord
      has_dag_links ancestor_class_names: %w(MyStructureable Group), descendant_class_names: %w(MyStructureable Group User), link_class_name: 'DagLink'
