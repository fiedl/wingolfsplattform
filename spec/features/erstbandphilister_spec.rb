...
feature "Erstbandphilister" do
  ...
  before do
    ...
    @esrtbandphilister_group = @philisterschaft_group.erstbandphilister_parent
  ...
  specify 'requirements' do
    ...
    @corporation.descendant_groups.where(name: "Erstbandphilister").first.member_table_rows.count.should == 1
  end
