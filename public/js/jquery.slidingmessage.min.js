(function(){
    jQuery.showMessage=function(b,a){
        ...
        if(settings.position=="bottom"){
            ...
            var outerHeight = $('#'+settings.id).outerHeight();
            if (settings.closeWindow) {
                b='$("#'+settings.id+'").animate({top:"-'+outerHeight+'px"}, '+settings.speed+", false, function(){self.close();});";
            } else {
                b='$("#'+settings.id+'").animate({top:"-'+outerHeight+'px"}, '+settings.speed+");";
            }
            setTimeout(b,settings.delay)
        }
    }
