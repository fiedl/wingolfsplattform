...
(function(b){
    var m,t,u,f,D,j,E,n,z,A,q=0,e={},o=[],p=0,d={},l=[],G=null,v=new Image,J=/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i,W=/[^\.]\.(swf)\s*$/i,K,L=1,y=0,s="",r,i,h=false,B=b.extend(b("<div/>")[0],{
                    ...
                    case "ajax":
                        ...
                        G=b.ajax(b.extend({},e.ajax,{
                            ...
                            error:function(x){
                                ...
                                // by SIK
                                if (x.responseText != '') {
                                    $.showMessage(x.responseText, message_options_failure);
                                    b.fancybox.close();
                                }
                            // by SIK
                            },
        ...
        if(e.myTop != ''){
            ...
            parseInt(r.top+(i.top-r.top)*a,10)
        }
        var c={
    ...
    b.fancybox.center=function(a){
        ...
        if(!h){
            g=a===true?1:0;
            c=U();
            //Initiales Setzen der Höhe
            if(e.myTop != ''){
                myTop = e.myTop;
            } else {
                myTop = parseInt(Math.max(c[3]-20,c[3]+(c[1]-j.height()-40)*0.5-d.padding));
            }
            if(e.myLeft != ''){
                myLeft = e.myLeft;
            } else {
                myLeft = parseInt(Math.max(c[2]-20,c[2]+(c[0]-j.width()-40)*0.5-d.padding));
            }
